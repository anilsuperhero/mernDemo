...
import { submitadminData, createadminData } from "../../actions/adminActions";
...
const FormModal = (props) => {
  ...
  const onSubmit = (data) => {
    ...
    if (item._id) {
      dispatch(submitadminData(formData, goToPreviousPath));
    } else {
      dispatch(createadminData(formData, goToPreviousPath));
    }
  };
